...
class HVACDescription(BaseModel):
    ...
    Attributes:
        ...
        raw_text: Original description text from Excel
            - As provided by user in the input file
            - Not normalized or cleaned (preserved for transparency)
            - Example: "Montaż zaworu kulowego DN50 PN16 z napędem elektrycznym"
    ...
    Business Rules:
        ...
        - If match_score is set, matched_reference_id should also be set (not enforced in Phase 1)
    ...
    raw_text: str = Field(
        ...,
        description="Original description text from Excel",
        min_length=1,
        max_length=1000,
    )
    ...
    def validate_raw_text_not_empty(cls, v: str) -> str:
        """
        Validate that raw_text is not just whitespace.
        ...
        Returns:
            Validated raw text (stripped of leading/trailing whitespace)
